        ...
        {geoData && (
          <>
            <div className="p-4 absolute -top-12 z-20  bg-base-100 bg-opacity-70 grid grid-cols-4 justify-center items-center w-[80%] rounded-[0.5rem]  ">
                <div className="title pr-4 overflow-auto scrollbar-hide cursor-pointer "><h1 className="text-xs text-orange-200 font-bold text-center lg:text-start ">IP ADDRESS</h1><span className="text-xs lg:text-2xl">{geoData.ip}</span></div>
                <div className="title px-4 overflow-auto scrollbar-hide cursor-pointer  border-l-2 border-l-gray-200 text-center lg:text-start"><h1 className="text-xs text-orange-200 font-bold">LOCATION</h1><span className="text-xs lg:text-2xl">{geoData.city}{geoData.city && ","} {geoData.country}</span></div>
                <div className="title px-4 overflow-auto scrollbar-hide cursor-pointer border-l-2 border-l-gray-200  text-center lg:text-start"><h1 className="text-xs text-orange-200 font-bold">TIMEZONE</h1> <span className="text-xs lg:text-2xl">{geoData.timezone}</span></div>
                <div className="title px-4 overflow-auto scrollbar-hide cursor-pointer border-l-2 border-l-gray-200 text-center lg:text-start "><h1 className="text-xs text-orange-200 font-bold">ISP</h1> 
